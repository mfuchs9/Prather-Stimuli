...
expName = u'Line_stimv1000'  # from the Builder filename that created this script
...
# Initialize components for Routine "num_prompt"
num_promptClock = core.Clock()
...
rating = visual.RatingScale(win=win, name='rating', marker=u'triangle', size=1.0, pos=[0.0, -0.4], low=0, high=1000, labels=[u'0', u'1000'], scale=u'', tickHeight=0, showValue=False)
...
for thisTrial in trials:
    ...
    # ------Prepare to start Routine "num_prompt"-------
    t = 0
    num_promptClock.reset()  # clock
    frameN = -1
    continueRoutine = True
    ...
    while continueRoutine:
        ...
        # update/draw components on each frame
        # *rating* updates
        if t >= 2.3 and rating.status == NOT_STARTED:
            # keep track of start time/frame for later
            rating.tStart = t
